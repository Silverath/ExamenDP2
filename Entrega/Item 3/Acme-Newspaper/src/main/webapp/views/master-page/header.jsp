...
<div>
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.molets" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="molet/list.do"><spring:message code="master.page.molets.list" /></a></li>
					<li><a href="molet/listMine.do"><spring:message code="master.page.molets.listMine" /></a></li>
				</ul>
			</li>
			<li><a class="fNiv"><spring:message	code="master.page.chirp" /></a>
				<ul>
