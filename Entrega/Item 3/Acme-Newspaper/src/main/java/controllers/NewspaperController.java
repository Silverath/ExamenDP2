...
public class NewspaperController extends AbstractController {
	...
	@RequestMapping(value = "/associatedMolets", method = RequestMethod.GET)
	public ModelAndView associatedMolets(@RequestParam final int newspaperId) {
		ModelAndView result;
		final Collection<Molet> molets = this.moletService.findAllPublicated();
