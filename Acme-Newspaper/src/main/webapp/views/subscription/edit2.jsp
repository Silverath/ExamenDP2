...
<form:form action="subscription/editSubscribeVolume.do" modelAttribute="subscription">
...
<form:label path="volume">
		<spring:message code="subscription.volume"/>
	</form:label>
		<form:select path="volume">
		<form:options items="${volume}" itemLabel="title" itemValue="id"/>
	</form:select>
	<br />
	<br />
